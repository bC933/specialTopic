...
<body>
	...
	<div class="agileinfo-main about-top">  
		...
		<div class="agileinfo-header">
			<div class="container">
				<div class="agile-logo">
					<h1><a href="index1.jsp"><i class="fa fa-music bounce bounceIn animated" aria-hidden="true"></i> Coldplay专题</a></h1>
				</div>
		...
		<div class="top-nav">
			...
			<ul class="w3l">
				...
				<li><a href="getComment?model_Location=songs" class="active"><i class="glyphicon glyphicon-headphones"></i><span>歌曲</span></a></li>
				<li><a href="getComment?model_Location=album"><i class="glyphicon glyphicon-list-alt"></i><span>专辑</span></a></li>
				<li><a href="getComment?model_Location=contact"><i class="glyphicon glyphicon-envelope"></i><span>加入我们</span></a></li>
			</ul>
			<!-- script-for-menu -->
			<script>
	...
	<div class="codes">
		<div class="container">
			<h3 class="agile-title">${songsValue}</h3>
